...
const NecessitiesAdd = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const st="Available"
            // alert(img)
            axios.post('http://localhost:5000/necessitiesAdd',{aname,desc1,amt,img1})
            .then(res=>{
            console.log(res)
            // navigate('/Login')
...
<input type="text" className='form-control'  onChange={e=>setaname(e.target.value)} required/>
                            </div>
